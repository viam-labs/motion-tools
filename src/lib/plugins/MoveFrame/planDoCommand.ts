/**
 * The builtin motion service's two `DoCommand` verbs, absent from the motion proto and so from any
 * generated client. `plan` takes a protojson `MoveRequest` string; `execute` runs a trajectory
 * verbatim.
 */
