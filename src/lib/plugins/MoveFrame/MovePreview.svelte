...
<div class="flex flex-col gap-2">
	...
	{#if ready}
		<!--
			Information rather than a warning: a plan is a validated path and nothing more, so both
			caveats are true of every plan, always, and nothing has gone wrong when they are.
		-->
