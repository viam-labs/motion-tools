...
/**
 * Merge one incoming transform-change event into the pending buffer, keyed by `uuidString`.
 *
...
const copyFields = (
	target: TransformWithUUID,
	source: TransformWithUUID,
	fields: Set<TransformField>
): void => {
