...
Open the **Reference plane** folder. Pick a placement mode (**Free (click to place)** or **Offset from coordinate plane**) and a normal axis (`YZ`, `XZ`, `XY`):
...
Open the **Reference geometry** folder. Pick a placement mode (**At origin** or **Free (click to place)**), a shape (`Box`, `Sphere`, `Capsule`), and toggle **Solid** / **Wireframe**:
